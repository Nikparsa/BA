...
```
cd existing_repo
git remote add origin https://git-iit.fh-joanneum.at/msd-webapp/ws24_students/nikparsa.git
git branch -M main
...
- [ ] [Set up project integrations](https://git-iit.fh-joanneum.at/msd-webapp/ws24_students/nikparsa/-/settings/integrations)
